            ...
            <div class="bg-white shadow sm:rounded-lg p-6">
                ...
                <form action="{{ route('products.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="unit" class="shadow-sm appearance-none border @error('unit') border-red-500 @else border-gray-300 @enderror rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500">
